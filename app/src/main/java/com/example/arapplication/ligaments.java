...
public class ligaments extends AppCompatActivity implements Scene.OnUpdateListener {
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        Toast.makeText(ligaments.this, "Camera permission needed", Toast.LENGTH_SHORT).show();
                    }
    ...
    private boolean buildDatabase(Config config) {
        ...
        augmentedImageDatabase.addImage("hand",bitmap);
    ...
    private Bitmap loadImage() {
        try {
            InputStream is = getAssets().open("hand_poly.jpg");

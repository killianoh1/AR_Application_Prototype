...
public class bones extends AppCompatActivity implements Scene.OnUpdateListener {
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        Toast.makeText(bones.this, "Camera permission needed", Toast.LENGTH_SHORT).show();
                    }
